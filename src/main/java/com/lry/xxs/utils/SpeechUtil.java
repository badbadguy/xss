...
public class SpeechUtil {
    ...
    public static final String APP_ID = "15738299";

    public static final String API_KEY = "SzTD1NravWGa1php7Ubaz82M";

    public static final String SECRET_KEY = "W3abc5AEs35207Tv1plGNxZPx1wGPWCp";
